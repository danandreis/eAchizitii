...
namespace eAchizitii.Migrations
{
    ...
    [Migration("20230117201402_addCampNumeFisierBDTabelaFisier")]
    partial class addCampNumeFisierBDTabelaFisier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eAchizitii.Models.Fisier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("numeFisierBazaDate")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("numeFisierDisc")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.HasIndex("InfoComandaId");
            ...
            modelBuilder.Entity("eAchizitii.Models.InfoComanda", b =>
                {
                    ...
                    b.ToTable("InfoComenzi");
                });

            modelBuilder.Entity("eAchizitii.Models.MesajComanda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eAchizitii.Models.Fisier", b =>
                {
                    b.HasOne("eAchizitii.Models.InfoComanda", "infoComanda")
                        .WithMany("fisiere")
                        .HasForeignKey("InfoComandaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("infoComanda");
                });
            ...
            modelBuilder.Entity("eAchizitii.Models.InfoComanda", b =>
                {
                    ...
                    b.HasOne("eAchizitii.Models.AppUser", "utilizator")
                        .WithMany("InfoComanda")
